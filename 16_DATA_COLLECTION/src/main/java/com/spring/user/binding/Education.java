...
public class Education {
	...
	public String toString() {
		return "Education [educationId=" + educationId + ", highestDegree=" + highestDegree + ", graduationYear="
				+ graduationYear + ", universityName=" + universityName + ", caseNum=" + caseNum + "]";
	}
	public Education(Integer educationId, String highestDegree, Integer graduationYear, String universityName,
			long caseNum) {
		super();
		this.educationId = educationId;
		this.highestDegree = highestDegree;
